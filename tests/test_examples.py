...
@pytest.mark.skip(reason="ModuleNotFoundError: no module named 'examples.ex1'")
...
@pytest.mark.skip(reason="ModuleNotFoundError: no module named 'examples.blend_naca'")
